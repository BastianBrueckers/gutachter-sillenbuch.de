...
function initRatgeberBreadcrumbsAndSchemas() {
  ...
  if (!document.querySelector('script[data-breadcrumb-schema]')) {
    var breadcrumbSchema = {
      ...
      '@type': 'BreadcrumbList',
      itemListElement: [
        { '@type': 'ListItem', position: 1, name: 'Startseite', item: 'https://gutachter-sillenbuch.de/' },
        { '@type': 'ListItem', position: 2, name: 'Ratgeber', item: 'https://gutachter-sillenbuch.de/ratgeber/' },
...
function init130Rechner() {
  ...
  var statusContent = {
    safe: {
      ...
      fictiveNote: 'Wenn Sie den Schaden nicht oder selbst reparieren möchten, können Sie auf Basis des Gutachtens abrechnen und erhalten diesen Betrag von der Versicherung.',
